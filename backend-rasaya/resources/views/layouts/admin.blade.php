        ...
        <div class="container-fluid px-4">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown me-3">
                    <a class="nav-link position-relative p-2" href="#" role="button" data-bs-toggle="dropdown" style="color: #64748b; transition: all 0.2s;" onmouseover="this.style.color='#1e3a8a'" onmouseout="this.style.color='#64748b'">
